...
import net.jradius.ssl.CipherSuite.*;
import net.jradius.ssl.HandshakeMessage.*;
...
public abstract class Handshaker {
    ...
    public byte[] getClntRandomBytes()
    {
    	return clnt_random.random_bytes;
    }
    
    public byte[] getSvrRandomBytes()
    {
    	return svr_random.random_bytes;
    }
}
